...
test_univariate_normal_smc_likelihood(observation::Float64, parameters::Vector{Float64}) = pdf(Normal(parameters[1], parameters[2]^2), observation);
test_univariate_normal_smc_gradient(observation::Float64, parameters::Vector{Float64}) = zeros(length(parameters));
...
function test_univariate_normal_smc(N::Int64, M::Int64, num_particles::Int64; μ0::Float64=0.0, σ0::Float64=1.0, λ::Float64=100.0)
    ...
    for i=1:M
        ...
        system = ParticleSystem(
            ...
            reverse([rand(Normal(0, λ^2), num_particles) rand(InverseGamma(3, 1), num_particles)]),
